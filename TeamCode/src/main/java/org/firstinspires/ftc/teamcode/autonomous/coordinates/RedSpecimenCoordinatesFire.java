...
public class RedSpecimenCoordinatesFire {
    ...
    private static final Pose2d score3 = new Pose2d(score3X, scoreY, scorePoseHeading);
    ...
    private static final Pose2d moveSpecimensStart0 = new Pose2d(28, -20, startPoseHeading);
